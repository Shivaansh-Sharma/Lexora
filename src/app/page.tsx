  ...
  return (
    ...
    <main className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute left-[-10%] top-[-10%] h-[550px] w-[550px] rounded-full bg-violet-600/20 blur-3xl" />

        <div className="absolute bottom-[-10%] right-[-10%] h-[550px] w-[550px] rounded-full bg-indigo-600/20 blur-3xl" />

        <div className="absolute left-1/2 top-1/3 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-fuchsia-500/10 blur-3xl" />
      </div>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24 pt-20">
        ...
        <div className="grid items-center gap-20 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-12 flex flex-wrap gap-5">
              ...
              <a
                href="/login"
                className="group inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-violet-600 to-indigo-600 px-8 py-4 text-base font-semibold text-white shadow-[0_0_40px_rgba(124,58,237,0.25)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_0_60px_rgba(124,58,237,0.35)]"
              >
        ...
        <div className="mt-32 overflow-hidden rounded-[2.5rem] border border-white/10 bg-gradient-to-br from-violet-600/15 via-background to-indigo-600/10 p-12 shadow-[0_0_60px_rgba(124,58,237,0.12)]">
