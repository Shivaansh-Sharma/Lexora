        ...
        <div className="flex w-full flex-col justify-between p-14">
          ...
          <div>
            ...
            <h1 className="mt-10 max-w-2xl text-6xl font-black tracking-tight">
              ...
              Build intelligent workflows with semantic AI.
            </h1>

            <p className="mt-8 max-w-xl text-lg leading-9 text-muted-foreground">

              Join Lexora to unlock multilingual NLP analysis, AI detection, semantic comparison, intelligent reporting, and enterprise-grade text intelligence.
            </p>
          </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 leading-7 text-muted-foreground">
                    ...
                    Advanced transformer-powered semantic systems with multilingual understanding and intelligent analytics.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="rounded-[2.5rem] border border-white/10 bg-card/70 p-10 backdrop-blur-2xl shadow-[0_0_60px_rgba(124,58,237,0.12)]">
            ...
            <div className="mb-10 text-center">
              ...
              <p className="mt-3 text-muted-foreground">
                ...
                Start your premium AI intelligence workflow.
              </p>
            </div>
